<div>
    ...
    <div x-data="LivewireUIModal()" x-init="init()" x-on:close.stop="show = false"
        ...
        style="display: none;">
        <div class="flex items-end justify-center min-h-screen px-4 pb-10 text-center sm:items-center">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block w-full align-bottom bg-white rounded-md text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full max-w-2xl">
